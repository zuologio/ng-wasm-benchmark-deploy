...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/@ngtools/webpack/src/index.js!./src/app/wasm-cpp/cpp-worker.worker.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/@ngtools/webpack/src/index.js!./src/app/wasm-cpp/cpp-worker.worker.ts":
/*!***********************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src!./src/app/wasm-cpp/cpp-worker.worker.ts ***!
  \***********************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _assets_cpp_fibonacci_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../assets/cpp/fibonacci.js */ "./src/assets/cpp/fibonacci.js");
/* harmony import */ var _assets_cpp_fibonacci_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_assets_cpp_fibonacci_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _file_loader_name_assets_cpp_fibonacci_wasm_assets_cpp_fibonacci_wasm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !file-loader?name=../../assets/cpp/fibonacci.wasm!../../assets/cpp/fibonacci.wasm */ "./node_modules/file-loader/dist/cjs.js?name=../../assets/cpp/fibonacci.wasm!./src/assets/cpp/fibonacci.wasm");
/* harmony import */ var _file_loader_name_assets_cpp_fibonacci_wasm_assets_cpp_fibonacci_wasm__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_file_loader_name_assets_cpp_fibonacci_wasm_assets_cpp_fibonacci_wasm__WEBPACK_IMPORTED_MODULE_3__);
...
var wasmReady = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](false);
var mod;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, instantiateWasm('../../assets/cpp/fibonacci.wasm')];
                case 1:
                    _b.sent();
                    fibonacci(data.index, data.iterations, data.useRecursion).subscribe(function (r) {
...
function instantiateWasm(url) {
    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
        var wasmFile, buffer, binary, moduleArgs;
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    wasmFile = _a.sent();
                    return [4 /*yield*/, wasmFile.arrayBuffer()];
                case 2:
                    buffer = _a.sent();
                    ...
                    mod = _assets_cpp_fibonacci_js__WEBPACK_IMPORTED_MODULE_2__(moduleArgs);
                    return [2 /*return*/];
            }
        });
    });
...
//   )
// }
function fibonacci(input, iterations, useRecursion) {
    return wasmReady.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(function (value) { return value === true; })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function () {
        var result = 0;
        var times = []; // reset timer
        for (var i = 0; i < iterations; i++) {
            ...
            if (useRecursion) {
                ...
                var resMs = big_integer__WEBPACK_IMPORTED_MODULE_5__(mod._getResMs());
                var resLs = big_integer__WEBPACK_IMPORTED_MODULE_5__(mod._getResLs());
                // console.log(resLs);
        ...
        var averageTime = Math.round((totalTime / iterations) * 100) / 100;
        return { result: result, totalTime: totalTime, averageTime: averageTime };
    }));
}
...
/***/ "./node_modules/file-loader/dist/cjs.js?name=../../assets/cpp/fibonacci.wasm!./src/assets/cpp/fibonacci.wasm":
/*!*******************************************************************************************************************!*\
  !*** ./node_modules/file-loader/dist/cjs.js?name=../../assets/cpp/fibonacci.wasm!./src/assets/cpp/fibonacci.wasm ***!
  \*******************************************************************************************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "../../assets/cpp/fibonacci.wasm";
