...
let wasmReady = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](false);
let mod;
...
addEventListener('message', ({ data }) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](undefined, void 0, void 0, function* () {
    console.log('c-worker');
    yield instantiateWasm('../../assets/c/fibonacci.wasm');
...
function fibonacci(input, iterations, useRecursion) {
    return wasmReady.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(value => value === true)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(() => {
        let result = 0;
        ...
        for (let i = 0; i < iterations; i++) {
            ...
            if (useRecursion) {
                ...
                let resMs = big_integer__WEBPACK_IMPORTED_MODULE_5__(mod._getResMs());
                let resLs = big_integer__WEBPACK_IMPORTED_MODULE_5__(mod._getResLs());
                // console.log(resLs);
